...
Bound(forms3,FreyF,1,[5,13,29,41]);
print "++++++++++++++++++++++", Realhours();

print "";
print "The prime p = 11 survives for the form no 4 ; we discard it using refined elimination with q = 5 :";
refined_Bound(forms3[4],FreyF,1,[5]);
print "++++++++++++++++++++++", Realhours();
print "";
